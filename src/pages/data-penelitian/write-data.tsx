...
import { TDataOCRScan, TDataPenelitian, TResp1Penelitian } from '../../Types/TPenelitian';
    ...
    */
    ...
    const saveHandler = async () => {
        ...
        if (id !== "-1") { // in EDIT mode
            try {
                toast("Please wait");
                const res = await axios.post(`${process.env.NEXT_PUBLIC_BASE_URL}/api/v1/penelitian/updatePenelitianById/${id}`, formData, auth);
